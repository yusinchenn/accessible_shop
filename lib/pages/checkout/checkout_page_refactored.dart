          ...
          child: ListView(
            ...
            children: [
              AccessibleGestureWrapper(
                label: '不使用優惠券',
                description: selectedCoupon == null ? '目前已選擇' : '點擊選擇',
                onTap: () {
              ...
              ...coupons.map((coupon) {
                ...
                final speakText = '${coupon.name}，${coupon.description}，${isAvailable ? "可使用" : "未達最低消費金額"}';

                return AccessibleGestureWrapper(
                  label: speakText,
                  description: isSelected
                      ? '目前已選擇'
                      : (isAvailable ? '點擊選擇此優惠券' : '無法使用'),
                  enabled: isAvailable,
                  onTap: isAvailable
                      ? () {
                          onCouponSelected(coupon);
        ...
        Expanded(
          child: ListView(
            ...
            children: shippingMethods.map((method) {
              ...
              final speakText = '${method.name}，${method.description}，運費${method.fee.toStringAsFixed(0)}元';

              return AccessibleGestureWrapper(
                label: speakText,
                description: isSelected ? '目前已選擇' : '點擊選擇此配送方式',
                onTap: () {
          ...
          child: ListView(
            ...
            children: [
              ...
              ...paymentMethods.map((method) {
                ...
                final speakText = '${method.name}，${method.description}';

                return AccessibleGestureWrapper(
                  label: speakText,
                  description: isSelected ? '目前已選擇' : '點擊選擇此付款方式',
                  onTap: () {
