...
NotificationModel _notificationModelDeserialize(
  ...
  object.orderNumber = reader.readStringOrNull(offsets[3]);
  object.timestamp = reader.readDateTime(offsets[4]);
  object.title = reader.readString(offsets[5]);
  object.type =
      _NotificationModeltypeValueEnumMap[reader.readByteOrNull(offsets[6])] ??
...
extension NotificationModelQueryProperty
  ...
  QueryBuilder<NotificationModel, int?, QQueryOperations> orderIdProperty() {
    return QueryBuilder.apply(this, (query) {
