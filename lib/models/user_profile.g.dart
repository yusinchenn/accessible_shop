...
int _userProfileEstimateSize(
  ...
  {
    final value = object.membershipLevel;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipLevelIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'membershipLevel',
      ));
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipLevelIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'membershipLevel',
      ));
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipLevelContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'membershipLevel',
        value: value,
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipLevelMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'membershipLevel',
        wildcard: pattern,
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipPointsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'membershipPoints',
      ));
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipPointsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'membershipPoints',
      ));
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      membershipPointsEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'membershipPoints',
        value: value,
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByMembershipLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'membershipLevel', Sort.desc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByMembershipPoints() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'membershipPoints', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy>
      sortByMembershipPointsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'membershipPoints', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByWalletBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByWalletBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'walletBalance', Sort.asc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByMembershipLevel(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'membershipLevel',
          caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QDistinct>
      distinctByMembershipPoints() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'membershipPoints');
    });
  }
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByWalletBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, String?, QQueryOperations>
      membershipLevelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'membershipLevel');
    });
  }

  QueryBuilder<UserProfile, int?, QQueryOperations> membershipPointsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'membershipPoints');
    });
  }
  ...
  QueryBuilder<UserProfile, double?, QQueryOperations> walletBalanceProperty() {
    return QueryBuilder.apply(this, (query) {
